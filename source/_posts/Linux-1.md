...
> **软件选择：**![image-20220223174716248](https://gitee.com/li-il/pics/raw/master/20220228184527.png)软件选择之后会检查安装源，需要等待一会儿。
>
> **配置分区：**
>
> 选择【我要配置分区】，点击【完成】，后弹出界面。![image-20220223175032299](https://gitee.com/li-il/pics/raw/master/20220228184529.png)
>
> 接下来配置![image-20220223175441323](https://gitee.com/li-il/pics/raw/master/20220228184531.png)然后点击【接受更改】。
>
> **KDUMP：**
>
...
![image-20220223174232519](https://gitee.com/li-il/pics/raw/master/20220228184533.png)
...
1. 直接拷贝一份已经安装好的虚拟机文件。
   ...
   在文件夹里面复制粘贴。然后再VM里面选择【打开】。![image-20220223182419425](https://gitee.com/li-il/pics/raw/master/20220228184539.png)

2. 使用vm的安装操作

   注意：**克隆时需要先关闭linux系统**![image-20220223182150269](https://gitee.com/li-il/pics/raw/master/20220228184541.png)

## 虚拟机快照

如果在使用虚拟机的时候，想回到原来的某一个正常的状态（担心某些误操作造成系统异常），需要快照管理。

![image-20220223182746020](https://gitee.com/li-il/pics/raw/master/20220228184633.png)
...
2. 打开设置，![image-20220223200736307](https://gitee.com/li-il/pics/raw/master/20220228184639.png)

   ![image-20220223200911235](https://gitee.com/li-il/pic_bed/raw/master/img/20220315203942.png)
...
![image-20220223214801594](https://gitee.com/li-il/pics/raw/master/20220228184644.png)![image-20220223214951427](https://gitee.com/li-il/pics/raw/master/20220228184647.png)

![](https://gitee.com/li-il/pic_bed/raw/master/img/20220315204359.png)

![image-20220223214827389](https://gitee.com/li-il/pics/raw/master/20220228184648.png)
...
![image-20220223215708994](https://gitee.com/li-il/pics/raw/master/20220228184651.png)

然后在Windows系统下打开终端，尝试连接

![image-20220223215741625](https://gitee.com/li-il/pics/raw/master/20220228184652.png)

打开XShell，【新建】，名称可以随便写但是主机必须正确。![image-20220223215824277](https://gitee.com/li-il/pics/raw/master/20220228184701.png)

就可以连接到Linux系统了![image-20220223215953859](https://gitee.com/li-il/pics/raw/master/20220228184655.png)

#### 远程传输

打开Xftp，点击【新建】，<u>注意端口号也是22</u>

![image-20220223220130019](https://gitee.com/li-il/pic_bed/raw/master/img/20220315204429.png)

> 乱码解决：左上角文件 - 当前会话属性 - 左上角 常规，点击旁边的“选项”，将“编码”改为UTF-8

 ![image-20220223220410675](https://gitee.com/li-il/pics/raw/master/20220228184710.png)
...
![image-20220223223707481](https://gitee.com/li-il/pics/raw/master/20220228184714.png)
...
![image-20220224120333362](https://gitee.com/li-il/pics/raw/master/20220228184717.png)
...
> 补充：
>
> ![image-20220224123103176](https://gitee.com/li-il/pics/raw/master/20220228184722.png)

# Linux实操篇 实用指令

## 指定运行级别

![image-20220224123648038](https://gitee.com/li-il/pics/raw/master/20220228184725.png)

![image-20220224124500877](https://gitee.com/li-il/pics/raw/master/20220228184727.png)
...
1.	首先，启动系统，进入开机界面，在界面中按“e”进入编辑界面。如图![image-20220224125015927](https://gitee.com/li-il/pics/raw/master/20220228184736.png)
2.	进入编辑界面，使用键盘上的上下键把光标往下移动，找到以““Linux16”开头内容所在的行数”，在行的最后面输入：init=/bin/sh。如图![image-20220224125032894](https://gitee.com/li-il/pics/raw/master/20220228184737.png)
1.	接着，输入完成后，直接按快捷键：`Ctrl+x` 进入单用户模式。
4.	接着，在光标闪烁的位置中输入：`mount -o remount,rw /`（注意：各个单词间有空格），完成后按键盘的回车键（Enter）。
5.	在新的一行最后面输入：passwd， 完成后按键盘的回车键（Enter）。输入密码，然后再次确认密码即可(韩顺平提示: 密码长度最好8位以上,但不是必须的), 密码修改成功后，会显示passwd.....的样式，说明密码修改成功![image-20220224131459675](https://gitee.com/li-il/pics/raw/master/20220228184742.png)
1.	接着，在鼠标闪烁的位置中（最后一行中）输入：touch /.autorelabel（注意：touch与 /后面有一个空格），完成后按键盘的回车键（Enter）
2.	继续在光标闪烁的位置中，输入：exec /sbin/init（注意：exec与 /后面有一个空格），完成后按键盘的回车键（Enter）,等待系统自动修改密码(韩顺平提示：这个过程时间可能有点长，耐心等待)，完成后，系统会自动重启, 新的密码生效了![image-20220224131533785](https://gitee.com/li-il/pics/raw/master/20220228184744.png)

# 帮助指令

## 帮助信息类

![image-20220224184447524](https://gitee.com/li-il/pics/raw/master/20220228184747.png)
